...
If you want to give it a go, the starting point is [TripServiceTest.pas][3] and [TripService.pas][4]. Try unit testing it following the rule above.

For future comparisions, when you are done, you can always check [TripService_Original.pas][2]
